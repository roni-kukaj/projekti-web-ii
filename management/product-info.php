...
<div class="container">
    ...
    <div class="row w-25">
        <div class="col">
            <button class="btn btn-danger mt-1" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Delete Product</button>
        </div>
