...
<section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    We offer a variety of additional services to enhance your shopping experience,
                    including gift wrapping, personal shopping assistance, and more.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        We have carefully curated a selection of top-quality brands that meet our high standards
